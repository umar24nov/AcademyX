...
export const mockInstituteProfile: InstituteProfile = {
  ...
  slug: "sunrise",
  contactEmail: "contact@zenrix.app",
...
export const mockBatchDetailData: BatchDetailData = {
  ...
  assignments: 6,
  students: [
    { id: "stu_001", name: "Ayesha Khan", rollNumber: "ZX-2026-001", email: "ayesha.khan@zenrix.app", attendanceRate: 95, status: "Active" },
    { id: "stu_002", name: "Mohammed Imran", rollNumber: "ZX-2026-002", email: "mohammed.imran@zenrix.app", attendanceRate: 88, status: "Active" },
    { id: "stu_003", name: "Aisha Siddiqui", rollNumber: "ZX-2026-003", email: "aisha.siddiqui@zenrix.app", attendanceRate: 91, status: "Active" },
    { id: "stu_004", name: "Rohan Sharma", rollNumber: "ZX-2026-004", email: "rohan.sharma@zenrix.app", attendanceRate: 79, status: "Active" },
    { id: "stu_005", name: "Priya Patel", rollNumber: "ZX-2026-005", email: "priya.patel@zenrix.app", attendanceRate: 97, status: "Active" },
    { id: "stu_006", name: "Rahul Verma", rollNumber: "ZX-2026-006", email: "rahul.verma@zenrix.app", attendanceRate: 85, status: "Active" },
    { id: "stu_007", name: "Fatima Sheikh", rollNumber: "ZX-2026-007", email: "fatima.sheikh@zenrix.app", attendanceRate: 94, status: "Active" },
    { id: "stu_008", name: "Aditya Gupta", rollNumber: "ZX-2026-008", email: "aditya.gupta@zenrix.app", attendanceRate: 81, status: "Active" },
  ],
  liveClasses: [
